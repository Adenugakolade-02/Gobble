...
class BasicProduct extends StatelessWidget {
  ...
  const BasicProduct({required this.imageUrl, required this.amount, required this.name, required this.function, required this.rating, required this.id, required this.description});
  
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: ()=>Navigator.push(context,MaterialPageRoute(builder: (context)=>ProductDetails(imageUrl: imageUrl, amount: amount, name: name, id: id, description:description,))),
          child: Container(
